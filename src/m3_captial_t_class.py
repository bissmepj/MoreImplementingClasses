...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        """
        top_c1 = rg.Point(intersection_center.x - (width / 2), intersection_center.y - (letter_thickness / 2))
        top_c2 = rg.Point(intersection_center.x + (width / 2), intersection_center.y + (letter_thickness / 2))
        tall_c1 = rg.Point(intersection_center.x - (letter_thickness / 2), intersection_center.y - (letter_thickness / 2))
        tall_c2 = rg.Point(intersection_center.x + (letter_thickness / 2), intersection_center.y - (letter_thickness / 2) + height)
        self.h_rect = rg.Rectangle(top_c1, top_c2)
        self.v_rect = rg.Rectangle(tall_c1, tall_c2)
        # --------------------------------------------------------------
        # DONE: 3.
    ...
    def clone(self):
        ...
        clone = CapitalT(center, width, height, thickness)
